...
<ProjectPage>
	<div slot="page-text">
		<h1>Plugin Surf</h1>
		<p>Hired as a freelance developer to do parts of the frontend development for Plugin Surf in NextJS.</p>
	...
	<div slot="page-links">
		<ProjectLink url={"https://plugin.surf/"} title={"plugin.surf"} />
		<!-- <ViewOnGitHub href="" /> -->
	</div>
