		...
		<div class="relative flex min-h-[calc(100dvh_-_8rem)] w-full flex-col justify-center">
			<div class="hero-text text-justify">
				...
				<p class="prose leading-loose">
					...
					functional products that offer a great user experience. I specialize in NextJS and SvelteKit with TypeScript
					and Tailwind. Whether building complex web applications or optimizing existing platforms, I am committed to
